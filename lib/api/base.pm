...
#  to the global OpenAC configuration and blesses
#  it into an object of api::base class. This
#  makes it easy for OpenAC modules to access
...
sub AUTOLOAD {
    ...
    if($@) {
	$self->logging('LOG_ERR', "Function %s called by %s is not defined by OpenAC API",
				  $func_name,
				  caller());
	return undef;
    }
